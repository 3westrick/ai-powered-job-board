...
import { getJobListingApplicationIdTag } from "@/features/jobListingApplications/cache"
import {
    Dialog,
    DialogContent,
    DialogDescription,
                ...
                <div className="flex gap-4 items-start">
                    ...
                    <div className="ml-auto flex items-center gap-4">
                        ...
                        <Button size="icon" variant="outline" asChild>
                            <Link
                                href={`/?${convertSearchParamsToString(
                                    await searchParams
                                )}`}
                            >
        ...
        <Dialog>
            ...
            <DialogContent className="md:max-w-3xl max-h-[calc(100%-2rem)] overflow-hidden flex flex-col">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Applying for a job cannot be undone and is something you
                        can only do once per job listing.
                    </DialogDescription>
                </DialogHeader>
